...
def score_syzygy_moves(board: chess.Board,
                       scorer: Callable[[chess.syzygy.Tablebase, chess.Board], int] |
                               Callable[[chess.syzygy.Tablebase, chess.Board], float],
                       tablebase: chess.syzygy.Tablebase) -> dict[chess.Move, float]:
...
def score_gaviota_moves(board: chess.Board,
                        scorer: Callable[[chess.gaviota.NativeTablebase | chess.gaviota.PythonTablebase,
                                          chess.Board], int],
